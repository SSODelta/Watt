...
all_names (VAR s) = s
all_names (VAR_BIT s e) = s ++ show e
...
modulize_expr (VAR_BIT a e) = IdentBit a e
...
normalize ((Assign (LHSBit s e) exp) : r) = OR (VAR_BIT s e) (normalize_expr exp) : normalize r
...
normalize_expr (IdentBit s e) = VAR_BIT s e
